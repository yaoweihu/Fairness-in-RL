...
from allocation.config import REGULARIZE_ADVANTAGE, BETA_0, BETA_1, BETA_2, BETA_3, BETA_4, OMEGA
from allocation.agents.ppo.sb3.on_policy_algorithm import OnPolicyAlgorithm
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                if REGULARIZE_ADVANTAGE:
                    ...
                    advantages = (BETA_0 * advantages + BETA_1 * vt_term + BETA_2 * div_term + BETA_3 * long_term1 + BETA_4 * long_term2)
                    # -------------------------------------------------------------------------------------------
